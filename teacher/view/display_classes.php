...
or die ('Cannot connect to db');
    ...
    while ($row = $result->fetch_assoc()) {
				...
				echo "<tr><td><form method='post' action='./display_gradebook.php?classID=".$classID."'><button type='submit'>Select</button><input type='hidden' name='action' value='select_gradebook'></td></form>";
